...
for iteration in range(1, max_iter+1): #this line means do the loop for max_iteration times (we add 1 because it doesnt counts the last iteration)
    old_index_collector = []
    new_index_collector = []
    max_diff = 0.0
    ...
    if tolerance_flag == True:
        ...
        with open("isulated results.txt" , "w") as file:
            file.write("Result:" + "\n")
            for row in T:
        ...
        ax.set_title("dimension of 30cm*40cm - 1cm intervals - point by point Gauss-Seidel - ISOLATION MODE")
        ...
        plt.title('dimension of 30cm*40cm - 1cm intervals - point by point Gauss-Seidel - ISOLATION MODE')
