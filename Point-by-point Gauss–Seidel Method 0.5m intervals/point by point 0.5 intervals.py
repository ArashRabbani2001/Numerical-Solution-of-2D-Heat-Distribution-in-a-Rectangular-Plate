...
# defining griding values of the plate(changing dx and dy to 0.05m)
Nx, Ny = 7, 9  
...
for iteration in range(1, max_iter+1):
    ...
    if tolerance_flag == True:
        ...
        ax.set_title("dimension of 30cm*40cm - 0.05m intervals - point by point Gauss-Seidel")
        ...
        plt.title('dimension of 30cm*40cm - 0.05cm intervals - point by point Gauss-Seidel')
